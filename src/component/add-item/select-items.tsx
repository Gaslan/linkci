...
export default function SelectItems({onItemSelect}: {onItemSelect: (itemtype: ItemType) => void}) {
  return  (
    <div className="flex items-center gap-4 text-gray-500">
      <button onClick={() => onItemSelect('link')} className="bg-gray-50 grow border border-gray-200 rounded-md flex flex-col items-center justify-center gap-4 h-[calc((100vw-4rem)/3)] w-full focus:outline-none focus:ring focus:ring-gray-200 aspect-square">
